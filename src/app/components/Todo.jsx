...
const Todo = ({ todo, status, filteredTodos }) => {
  ...
  statusMap.set(0,"To Do")
  statusMap.set(1,"Completed")
  statusMap.set(2,"In Progress")

  const [todoStatus,setTodoStatus] = useState(statusMap.get(todo.is_complete))
      ...
      {isOpen && (
        <ModalComponent
          ...
          onClose={() => {
            ...
            setTodoStatus(statusMap.get(todo.is_complete))
